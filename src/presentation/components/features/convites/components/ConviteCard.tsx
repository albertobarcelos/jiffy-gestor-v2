...
export function ConviteCard({
  ...
  return (
    <div className="flex h-52 flex-col rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
            ...
            <div className="flex shrink-0 items-start justify-between gap-3">
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="inline-flex h-9 w-9 items-center justify-center rounded-full text-gray-500 transition hover:bg-gray-100 hover:text-gray-800 disabled:cursor-not-allowed disabled:opacity-50"
