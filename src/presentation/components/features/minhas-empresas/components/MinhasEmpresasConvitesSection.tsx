...
export function MinhasEmpresasConvitesSection({ children }: { children: ReactNode }) {
  return (
    <section aria-labelledby="minhas-empresas-convites-pendentes">
      <div className="relative mt-2 border-t-2 border-b-2 border-alternate/40 bg-gray-50 py-3">
        <h2
          id="minhas-empresas-convites-pendentes"
