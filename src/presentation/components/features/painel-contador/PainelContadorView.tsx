...
export function PainelContadorView() {
  ...
  return (
    <div className=" pb-2 flex h-full w-full flex-col items-stretch bg-info overflow-y-auto lg:flex-row lg:overflow-hidden">
      ...
      <div className="flex min-h-full flex-1 w-[60%] flex-col overflow-hidden rounded-tr-none rounded-br-none bg-secondary lg:rounded-tr-[48px] lg:rounded-br-[48px]">
      ...
      <div className="flex w-[40%] flex-col gap-2 sm:gap-2.5 md:gap-3 p-2 sm:p-2.5 md:p-3 lg:p-3 lg:min-h-full lg:overflow-auto">
        {/* Card Certificado */}
        <div className="flex min-h-[180px] flex-col gap-3 rounded-[24px] border border-primary bg-[#f6f8fc] p-3 sm:p-3.5 md:p-4">
          <h3 className="text-center font-exo font-medium text-primary text-sm sm:text-lg md:text-xl lg:text-2xl">
          ...
          <div className="flex flex-row gap-2">
            <div className="flex flex-col gap-2">
              ...
              <div className="mb-2 sm:mb-2.5 flex flex-col gap-0.75">
          ...
          <div className="flex flex-col w-full mb-2 items-center rounded-[10px]  px-3 py-1 gap-2">
            <Button
              ...
              className="rounded-lg bg-[#530ca3] px-3 py-2 text-white text-sm font-medium hover:bg-[#430a83]"
            >
        ...
        <div className="flex min-h-[180px] flex-col gap-3 rounded-[24px] border border-primary bg-[#f6f8fc] p-3 sm:p-3.5 md:p-4">
          ...
          <div className="flex flex-row gap-2">
            ...
            <div className="flex flex-col w-full mb-2 items-center rounded-[10px] px-3 py-1 gap-2">
              ...
              <div className="mb-2 sm:mb-2.5 inline-flex items-center rounded-lg bg-[#ffa3a3] px-3 py-1 h-[26px] sm:h-[28px] lg:h-[30px] w-fit">
