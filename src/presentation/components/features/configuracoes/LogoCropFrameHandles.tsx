...
/**
 * Alças nas bordas da moldura (centrada como o crop do react-easy-crop).
 * Largura e altura independentes até o máximo do cupom.
 */
export function LogoCropFrameHandles({
  ...
  const onPointerMove = useCallback(
    (e: PointerEvent) => {
      ...
      onSizeChange(clampCropFrameSize(next, maxSize))
    },
