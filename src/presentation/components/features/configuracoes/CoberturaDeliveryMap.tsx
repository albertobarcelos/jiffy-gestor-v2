...
export function CoberturaDeliveryMap({ origem, raios }: CoberturaDeliveryMapProps) {
  ...
  if (!isLoaded) {
    return <div className="h-[360px] animate-pulse rounded-lg bg-gray-100" aria-hidden />
  }

  if (!centro) {
    return (
      <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-6 text-center text-sm text-amber-950">
