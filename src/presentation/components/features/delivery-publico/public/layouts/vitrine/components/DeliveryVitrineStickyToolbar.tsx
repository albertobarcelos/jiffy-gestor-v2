...
import { DeliveryVitrineCategoriaTabs } from './DeliveryVitrineCategoriaTabs'

const PINNED_TITLE_GAP_PX = 10

type DeliveryVitrineStickyToolbarProps = {
...
/**
 * Toolbar de grupos + título do grupo ativo em `position: fixed`
 * (CSS sticky nos títulos da lista tremia no scroll).
 */
export const DeliveryVitrineStickyToolbar = memo(function DeliveryVitrineStickyToolbar({
  catalogRootRef,
  config,
  grupos,
  termoBusca,
  ...
  onBuscaChange,
  onGrupoClick,
}: DeliveryVitrineStickyToolbarProps) {
  ...
  // Mostra o título fixo só quando o título natural do grupo já passou da linha sticky.
  useEffect(() => {
