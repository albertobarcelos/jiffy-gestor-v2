...
function mapCobrancaDeliveryToPagamento(raw: unknown): PagamentoApiItem | null {
  ...
  const cobrarNaEntrega = momento === 'na_entrega'
  ...
  return {
    ...
    cobrarNaEntrega,
    efetivado: paga || pagamentoEfetivado != null,
    cancelado,
...
export function adaptPedidoDeliveryToVendaGestorApiResponse(
  ...
  return {
    ...
    statusVenda: dataFinalizacao ? 'FINALIZADA' : 'ABERTA',
