...
/** Geo capturada no checkout: localiza├º├úo do endere├ºo + ponto de entrega opcional. */
export type EnderecoGeoCheckoutInput = {
  enderecoLocalizacao: GeoJsonPoint
  providerEnderecoId?: string | null
  /** Ponto onde o cliente recebe o pedido (portaria, bloco etc.), sem alterar o texto do endere├ºo. */
