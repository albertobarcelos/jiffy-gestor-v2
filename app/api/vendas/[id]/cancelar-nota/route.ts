...
/**
 * POST /api/vendas/[id]/cancelar-nota
 * Cancela a nota fiscal vinculada a uma venda do PDV.
 */
export async function POST(
  ...
  try {
    ...
    const response = await apiClient.request<any>(`/api/v1/operacao-pdv/vendas/${id}/cancelar-nota`, {
      method: 'POST',
      headers: {
    ...
    console.error('Erro ao cancelar nota fiscal da venda PDV:', error)
