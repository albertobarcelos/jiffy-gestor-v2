...
/**
 * POST /api/delivery/empresas/me/logo/upload-intent
 * Proxy → POST /api/v1/delivery/empresas/me/logo/upload-intent
 */
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return proxyAuthenticatedBackendPost(
      '/api/v1/delivery/empresas/me/logo/upload-intent',
