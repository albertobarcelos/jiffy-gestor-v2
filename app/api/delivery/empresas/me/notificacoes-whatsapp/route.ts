...
const BACKEND_PATH = '/api/v1/delivery/empresas/me/notificacoes-whatsapp'
...
/** GET /api/delivery/empresas/me/notificacoes-whatsapp */
export async function GET(request: NextRequest) {
  try {
    ...
    return handleApiError(error, 'Erro ao listar notificações WhatsApp delivery:')
  }
}
