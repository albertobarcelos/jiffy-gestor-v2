...
const BACKEND_PATH = '/api/v1/delivery/empresas/me/funcionamento/toggle'
...
/** POST /api/delivery/empresas/me/funcionamento/toggle */
export async function POST(request: NextRequest) {
  try {
    ...
    return handleApiError(error, 'Erro ao alternar funcionamento da loja:')
  }
}
