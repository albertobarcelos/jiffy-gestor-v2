...
const BACKEND_PATH = '/api/v1/delivery/empresas/me/funcionamento/abrir'
...
/** POST /api/delivery/empresas/me/funcionamento/abrir */
export async function POST(request: NextRequest) {
  try {
    ...
    return handleApiError(error, 'Erro ao abrir loja manualmente:')
  }
}
