...
const BACKEND_PATH = '/api/v1/delivery/empresas/me/funcionamento/agenda'
...
/** GET /api/delivery/empresas/me/funcionamento/agenda */
export async function GET(request: NextRequest) {
  try {
    ...
    return handleApiError(error, 'Erro ao buscar agenda de funcionamento:')
  }
}

/** PUT /api/delivery/empresas/me/funcionamento/agenda */
export async function PUT(request: NextRequest) {
  try {
    ...
    return handleApiError(error, 'Erro ao salvar agenda de funcionamento:')
  }
}
