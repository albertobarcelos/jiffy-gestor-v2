...
const BACKEND_PATH = '/api/v1/delivery/empresas/me/funcionamento'
...
/** GET /api/delivery/empresas/me/funcionamento */
export async function GET(request: NextRequest) {
  try {
    ...
    return handleApiError(error, 'Erro ao buscar funcionamento delivery:')
  }
}
