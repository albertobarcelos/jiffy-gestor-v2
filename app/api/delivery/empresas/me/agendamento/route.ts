...
const BACKEND_PATH = '/api/v1/delivery/empresas/me/agendamento'
...
export async function GET(request: NextRequest) {
  try {
    ...
    return handleApiError(error, 'Erro ao buscar configuração de agendamento delivery:')
  }
}
...
export async function PUT(request: NextRequest) {
  try {
    ...
    return handleApiError(error, 'Erro ao atualizar configuração de agendamento delivery:')
  }
}
