 ...
 * Proxy → POST /api/v1/cardapio/grupos-complementos/:id/upload-intent
 */
export async function POST(
  ...
  try {
    ...
    return proxyAuthenticatedBackendPost(
      `/api/v1/cardapio/grupos-complementos/${encodeURIComponent(grupoComplementoId.trim())}/upload-intent`,
