...
/**
 * Instruções quando o delivery não foi encontrado ou não há slug válido.
 */
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        >
          ...
          >
            <li>1. Peça ao restaurante o link do delivery online</li>
            <li>2. O endereço tem o formato: /delivery/nome-da-loja</li>
