...
export function DeliveryWhatsAppFab({
  ...
  const nome = nomeLoja?.trim() || 'loja'
  const mensagem = `Olá! Vim pelo cardápio online da ${nome}.`
  ...
  return createPortal(
    <a
      ...
      className="fixed z-[90] flex h-14 w-14 items-center justify-center rounded-full text-white shadow-lg transition-transform hover:scale-105 active:scale-95"
      style={{
