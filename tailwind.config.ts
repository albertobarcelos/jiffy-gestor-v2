...
/**
 * Safelist do Tremor: classes de cor geradas dinamicamente nos gráficos.
 * Mantém o restante do app inalterado; só garante que o CSS dessas classes exista.
 */
const tremorSafelist: Config['safelist'] = [
  {
    pattern:
